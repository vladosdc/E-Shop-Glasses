...
export default function ChildrenProductPage({ params }: { params: { id: string } }) {
    const router = useRouter();
    const db = getFirestore(firebaseApp);
    
    const product = data.childrenglasses.find(item => item.id.toString() === params.id);
    ...
    return (
        <div className={styles.productPage}>
            ...
            <div className={styles.backButtonBlock}>
                <Button variant="outline-dark" onClick={() => router.push('/childrenglasses')}>
                    &larr; Back to Children Glasses
                </Button>
            </div>
