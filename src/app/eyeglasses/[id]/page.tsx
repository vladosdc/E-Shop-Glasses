...
export default function EyeglassProductPage({ params }: { params: { id: string } }) {
    const router = useRouter();
    const db = getFirestore(firebaseApp);
    
    // Ищем очки для зрения по ID из URL
    const product = data.eyeglasses.find(item => item.id.toString() === params.id);
    ...
    return (
        <div className={styles.productPage}>
            ...
            <div className={styles.backButtonBlock}>
                <Button variant="outline-dark" onClick={() => router.push('/eyeglasses')}>
                    &larr; Back to Eyeglasses
                </Button>
            </div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.infoSection}>
                    ...
                    <p className={styles.brand}>Brand: <b>{(product as any).brand}</b></p>
                    <p className={styles.description}>{(product as any).descriptions}</p>
