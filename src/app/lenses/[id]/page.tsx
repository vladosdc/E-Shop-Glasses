...
export default function LensesProductPage({ params }: { params: { id: string } }) {
    const router = useRouter();
    const db = getFirestore(firebaseApp);
    
    // Ищем линзы по ID из URL
    const product = data.lenses.find(item => item.id.toString() === params.id);
    ...
    return (
        <div className={styles.productPage}>
            ...
            <div className={styles.backButtonBlock}>
                <Button variant="outline-dark" onClick={() => router.push('/lenses')}>
                    &larr; Back to Contact Lenses
                </Button>
            </div>
