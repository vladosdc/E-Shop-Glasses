        ...
        <div className={styles.account}>
            <div className={styles.account__container}>
                ...
                <div className={styles.account__cards}>
                    ...
                    <div className={styles.account__cards__addressCard} onClick={() => router.push('/account/address')}>
                    <Image
                    ...
                    {/* order card (не ваучери) */}
                    <div className={styles.account__cards__vouchersCard} onClick={() => router.push('/account/orders')}>
                        <Image
                            className={styles.account__cards__vouchersImg}
                            src={voucherImg} alt="Address" width={40}/>
                        <p className={`${styles.account__cards__text} ${styles.account__cards__textVouchers}` }>Orders</p>
                    </div>
                </div>
