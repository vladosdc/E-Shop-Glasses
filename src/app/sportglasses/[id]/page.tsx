...
export default function SportProductPage({ params }: { params: { id: string } }) {
    const router = useRouter();
    const db = getFirestore(firebaseApp);
    
    // Ищем спортивные очки по ID из URL
    const product = data.sportglasses.find(item => item.id.toString() === params.id);
    ...
    return (
        <div className={styles.productPage}>
            ...
            <div className={styles.backButtonBlock}>
                <Button variant="outline-dark" onClick={() => router.push('/sportglasses')}>
                    &larr; Back to Sport Glasses
                </Button>
            </div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.infoSection}>
                    ...
                    {/* Если бренда или описания пока нет, показываем заглушку, чтобы дизайн не ломался */}
                    <p className={styles.brand}>Brand: <b>{(product as any).brand || 'Sport'}</b></p>
                    <p className={styles.description}>
                        {(product as any).descriptions || 'Excellent sport glasses for an active lifestyle. Stay protected and perform at your best.'}
                    </p>
                    ...
                    <div className={styles.features}>
                        ...
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureDesc}>1 year warranty + minor repairs.</p>
                        </div>
                        <div className={styles.featureItem}>
                            <ReturnIcon />
