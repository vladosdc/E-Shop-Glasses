            ...
            <div className={styles.sportglasses__container}>
                {filteredAndSortedData.map((sportglasses) => (
                    <div key={sportglasses.id} className={styles.sportglasses__card}>
                        <Image 
                            src={sportglasses.photo} 
                            alt={`${sportglasses.name} photo`} 
                            className={styles.sportglasses__photo} 
                            width={210} 
                            height={170} 
                            quality={100} 
                            onClick={() => goToProduct(sportglasses.id)}
                        ...
                        <div className={styles.sportglasses__price__cart__block}>
                            ...
                            <Button className={styles.sportglasses__buy__btn} onClick={() => goToProduct(sportglasses.id)} variant="light">
                                View & Buy
